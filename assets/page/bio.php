...
<html lang="fr">
    ...
    <head>
        ...
        <title>The body studio - Bio</title>
    </head>
        ...
        <main class="container-fluid" style="margin-left: 2%;">
            <div class="header">
                <div class="image-container">
                    <img src="../img/Rectangle 8.png" class="img-fluid clickable"
                        style="margin-left: 2%; border-radius: 5%;">
                    <p class="image-text">Text de presentation de la creation et des objectif de la salle de sport</p>
                </div>
                <div class="image-container">
                    <p class="image-text">Presentation des équipe : Coach accueil etc</p>
                    <img src="../img/Rectangle 9.png" class="img-fluid clickable"
                        style="margin-left: 2%; margin-bottom: 2%; border-radius: 5%">
                </div>
                <a href="./assets/page/gallery.html" class="galleryLink">Voir la galerie 📸</a>
            </div>
        </main>
