...
<html lang="fr">
    ...
    <head>
        ...
        <title>The body studio - planning</title>
    </head>
    ...
    <body style="background-color: #413C3C;">
        ...
        <main class="container-fluid" style="margin-left: 2%;">
            <div class="header">
                <a href="http://127.0.0.1:5500/assets/img/Rectangle%2033.png"> <img src="/assets/img/Rectangle 33.png"
                        class="img-fluid" style="margin-left: 2%;"></a>
